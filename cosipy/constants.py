...
' GENERAL INFORMATION ' 
dt = 3600 * 6                                   # Time step in the input files [s]
...
minimum_snowfall = 0.0001                        # minimum snowfall per time step in m which is added as new snow
...
albedo_fresh_snow = 0.88                        # albedo of fresh snow [-] (Moelg et al. 2012, TC)
albedo_firn = 0.58                              # albedo of firn [-] (Moelg et al. 2012, TC)
albedo_ice = 0.25                                # albedo of ice [-] (Moelg et al. 2012, TC)
albedo_mod_snow_aging = 2.5                      # effect of ageing on snow albedo [days] (Oerlemans and Knap 1998, J. Glaciol.)
albedo_mod_snow_depth = 1                       # effect of snow depth on albedo [cm] (Oerlemans and Knap 1998, J. Glaciol.)
